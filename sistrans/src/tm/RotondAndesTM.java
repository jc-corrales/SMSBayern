...
public class RotondAndesTM {
	...
	/**
	 * M�todo que obtiene un Menú según su ID y el ID del Restaurante dueño.
	...
	//---------------------------------------------------
	/**
	 * M�todo que Registra el Pedido de un Menú.
	 * @param id Long, ID del Cliente.
	...
	public ProductoLocal agregarProducto(Long idRestaurante, ProductoLocal producto) throws SQLException, Exception
	{
		...
		try {
			...
			{
				throw new Exception("El Restaurante no se encuentra en operaci�n.");
			}
	...
	/**
	 * M�todo que obtiene la información de un Restaurante.
	 * @param idRestaurante Long, ID del Restaurante
	...
	/**
	 * M�todo que obtiene si un cliente ha consumido un producto de un Restaurante dado por ID
	...
	//---------------------------------------------------
	/**
	 * M�todo que obtiene si un cliente NO ha consumido un producto de un Restaurante dado por ID
	 * en un rango de fechas.
	 * @param idCliente Long, ID del Cliente.
	 * @param idRestaurante Long, ID del Restaurante.
	 * @param fecha1 String, Cadena de la Fecha 1.
	...
	//---------------------------------------------------
	/**
	 * M�todo que retira un Restaurante del Servicio.
	 * @param idRestaurante Long, ID del Restaurante a Retirar.
	 * @return Restaurante, informaci�n del Restaurante retirado.
	 * @throws SQLException
	 * @throws Exception
	 */
...
//			respuesta = dao.obtenerRestaurante(idRestaurante);
	...
	//---------------------------------------------------
	/**
	 * M�todo que obtiene la Rentabilidad de los Restaurantes seg�n unos par�metros de b�squeda.
	...
	//---------------------------------------------------
	/**
	 * M�todo que obtiene la Rentabilidad de un Restaurante espec�fico.
	 * @param fecha1 String, cadena de la primera fecha del rango de consulta.
	 * @param fecha2 String, cadena de la segunda fecha del rango de consulta.
	 * @param criterio Integer, Criterio seg�n el cual se va a realizar la consulta.
	 * @param idProducto Long, ID del Producto seg�n el cual se va a realizar la consulta, si aplica.
	 ...
	 * @return ListaVideos - objeto que modela  un arreglo de videos. este arreglo contiene el resultado de la b�squeda
	...
	public ListaRentabilidad darRentabilidadRestaurantesUniversal(String fecha1, String fecha2, Integer criterio, Long idProducto) throws Exception {
		...
		try
		{
			...
			System.out.println("PAR�METROS UNIDOS: " + parametrosUnidos);
...
//			System.out.println(productoFromMapper.getCostoDeProduccion());
		...
		{
			System.out.println("ERROR EN GENERACI�N: " + e.getMessage());
		}
		return remL;
	}
	
	/**
	 * M�todo que obtiene los Productos seg�n parametros de b�squeda
	 * @param filtro
	 * @param parametro
	 * @return
	 * @throws Exception
	...
	/**
	 * M�todo que confirma las Credenciales de un administrador para los m�todos universales.
	 * @param idAdmin Long, ID del Administrador.
	 * @param passwordAdmin String, contrase�a del Administrador.
	 * @return Boolean.
	 * @throws SQLException
	 * @throws Exception
	 */
