...
public class RotondAndesTM {
	...
	/**
	 * MÈtodo que obtiene un Men˙ seg˙n su ID y el ID del Restaurante dueÒo.
...
//				conn.setAutoCommit(true);
	 ...
	 * @param idRestMenu Long, ID del Restaurante dueÒo del men˙.
...
//				conn.setAutoCommit(true);
	...
	//---------------------------------------------------	
		 ...
		 * @param idUsuario el idUsuario para autorizaciÛn
		 * @param contraseniaa la contraseÒa del usuario para autorizaciÛn
		 * @return Clientes
		 * @throws Exception 
		 */
