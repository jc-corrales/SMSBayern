...
//	}
	...
	/**
	 * Método que obtiene los productos m�s vendidos.
	...
	/**
	 * M�todo que obtiene un Men� con sus productos.
	 * @param id Long, ID del Men�.
	 * @param idRest Long, ID del Restaurante.
	 * @return Menu, Informaci�n del Men�.
	 * @throws SQLException
	 * @throws Exception
	 */
	public Menu darMenu(Long id, Long idRest) throws SQLException, Exception
	{
		...
		if(!rs.next())
		{
			throw new Exception("El men� con ID: " + id + " y que pertenece al Restaurante con ID: " + idRest + " no existe.");
		}
